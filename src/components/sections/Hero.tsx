    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
            ...
            <div className="container mx-auto px-6 md:px-12 flex items-center relative z-10 w-full h-full">
                ...
                {/* Right 3D Canvas - Positioned absolutely in background */}
                <div className="absolute top-1/2 -translate-y-1/2 right-[-10%] w-[120%] lg:w-[65%] lg:right-0 h-[400px] md:h-[600px] lg:h-[900px] z-0 pointer-events-none opacity-50 lg:opacity-90">
                ...
                <div className="flex flex-col items-start gap-4 md:gap-6 w-full relative z-40">
                    ...
                    <div className="flex flex-col gap-0.5 text-[8.5vw] xs:text-[9.5vw] leading-[1.1] sm:text-[4rem] md:text-6xl lg:text-[5rem] xl:text-[6rem] font-black tracking-tighter md:leading-[0.85] text-foreground font-heading uppercase relative w-fit mr-auto py-2 whitespace-nowrap">

                        {/* Circular Orbit Path - Hidden on mobile to prevent clutter */}
                    ...
                    >
                        <Button asChild size="lg" className="rounded-none gap-2 text-md group relative overflow-hidden bg-primary text-primary-foreground hover:bg-primary/90 border-0 w-full sm:w-auto h-12 md:h-11">
                            <a href="#projects">
                                <span className="relative z-10 flex items-center justify-center gap-2 font-heading font-bold uppercase tracking-widest w-full">Explore Work <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" /></span>
                            </a>
                        </Button>
