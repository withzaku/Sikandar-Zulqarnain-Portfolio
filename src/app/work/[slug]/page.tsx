        ...
        <div className="min-h-screen pt-32 pb-24 relative z-10">
            <div className="container mx-auto px-6 md:px-12 max-w-4xl">
                ...
                <div className="mt-8 pt-8 border-t border-border flex gap-4">
                    <a href="#" className="inline-flex items-center gap-2 px-6 py-4 rounded-none bg-card border border-border hover:border-primary hover:text-primary transition-all text-xs font-mono uppercase tracking-widest text-muted-foreground font-bold">
